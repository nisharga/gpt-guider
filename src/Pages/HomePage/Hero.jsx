        ...
        <div className="container mx-auto mt-16 md:mt-28">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mx-4 md:mx-0">
                <div className="text-white">
                    ...
                    <div>
                        <p className="text-sm md:text-[22px] md:leading-8 mt-3 md:mt-5">Increase your productivity, Elevate your learning experience with the most comprehensive and powerful AI tools.</p>
                    </div>
